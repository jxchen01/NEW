...
cmd:text()
cmd:text('Options:')
cmd:option('--modelPath','/home/jchen16/NEW/code/checkpoint/unet_12_300000.bin','path to the trained model')
cmd:option('--imageDir', '/home/jchen16/NEW/data/fungus/training_data_12', 'the directory to load')
cmd:option('--outputDir', '/home/jchen16/NEW/data/fungus/encoder_FM16_X12', 'the directory to save the input for RNN')
